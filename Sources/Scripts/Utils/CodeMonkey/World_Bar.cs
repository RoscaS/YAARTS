...
namespace Utils
{
    ...
    public class World_Bar
    {
        ...
        public static int
                GetSortingOrder(Vector3 position, int offset, int baseSortingOrder = 5000) {
        ...
        public World_Bar(Transform parent, Vector3 localPosition, Vector3 localScale,
                         Color? backgroundColor, Color barColor, float sizeRatio, int sortingOrder,
