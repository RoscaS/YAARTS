...
public static class UtilsClass
{
    ...
    public static int GetSortingOrder(Vector3 position,
                                      int offset,
    ...
    public static GameObject CreateWorldSprite(Transform parent,
                                               string name,
                                               Sprite sprite,
    ...
    public static Button_Sprite CreateWorldSpriteButton(string name,
                                                        Sprite sprite,
                                                        Vector3 localPosition,
                                                        Vector3 localScale,
                                                        int sortingOrder,
    ...
    public static void CreateWorldTextPopup(Transform parent,
                                            string text,
                                            Vector3 localPosition,
                                            int fontSize,
                                            Color color,
    ...
    public static FunctionUpdater CreateUITextUpdater(Func<string> GetTextFunc,
                                                      Vector2 anchoredPosition) {
        Text text = DrawTextUI(GetTextFunc(), anchoredPosition, 20);
    ...
    // Draw a UI Sprite
    public static RectTransform DrawSprite(Color color,
                                           Transform parent,
                                           Vector2 pos,
                                           Vector2 size,
                                           string name = null) {
    ...
    // Draw a UI Sprite
    public static RectTransform DrawSprite(Sprite sprite,
                                           Transform parent,
                                           Vector2 pos,
                                           Vector2 size,
                                           string name = null) {
    ...
    public static Text DrawTextUI(string textString, Vector2 anchoredPosition, int fontSize) {
        return DrawTextUI(textString, GetCanvasTransform(), anchoredPosition, fontSize);
    }
    ...
    public static Vector3 GetMouseWorldPositionWithZ(Vector3 screenPosition, Camera worldCamera) {
        Physics.Raycast(worldCamera.ScreenPointToRay(screenPosition), out var hit, 500f);
        return hit.point;
    }
